    ...
    <div class="layui-card-body">
        <form class="layui-form" lay-filter="cat-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="slug" class="layui-input" placeholder="留空则自动生成 category_{id}">
                </div>
            </div>
                ...
                <div class="layui-tab-content">
                    ...
                    <div class="layui-tab-item {{ $i===0 ? 'layui-show' : '' }}">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="name[{{ $l }}]" class="layui-input" {{ $i===0 ? 'required' : '' }}>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">描述</label>
                            <div class="layui-input-block">
                                <textarea name="description[{{ $l }}]" class="layui-textarea"></textarea>
                            </div>
                        </div>
                    </div>
                    @endforeach
...
layui.use(['form'], function(){
    ...
    form.on('submit(save)', function(data){
        $.ajax({
            url: "{{ route('lpadmin.blog.category.store') }}",
            method: 'POST',
            data: data.field,
