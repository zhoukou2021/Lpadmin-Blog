...
<style>
  ...
  /* 分类头部布局 */
  .category-header{display:flex;align-items:flex-start;justify-content:space-between;gap:16px;width:100%;border-bottom: 1px solid var(--primary);
    padding-bottom: 15px;box-sizing:border-box}
  .category-info{flex:1;min-width:0;width:0;box-sizing:border-box}
  .category-title{margin:0;font-size:20px;font-weight:700;color:var(--primary);line-height:1.4;word-break:break-word;overflow-wrap:break-word}
  .category-desc{margin-top:6px;color:#666;font-size:14px;line-height:1.6;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:100%;box-sizing:border-box;word-break:break-all}
  ...
  @media (max-width: 767.98px){
    .category-header{flex-direction:row;align-items:flex-start;gap:12px;padding-bottom:12px;width:100%}
    .category-info{flex:1;min-width:0;width:0;max-width:none;box-sizing:border-box}
    .category-title{font-size:18px}
    .category-desc{font-size:13px;margin-top:4px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;max-width:100%;width:100%;box-sizing:border-box}
    .view-switcher{margin-top:0;flex-shrink:0}
    .view-btn{width:36px;height:36px}
    .view-btn i{font-size:14px}
  }
  @media (max-width: 575.98px){
    .category-header{padding-bottom:10px;gap:10px}
    .category-info{flex:1;min-width:0}
    .category-title{font-size:16px}
    .category-desc{font-size:12px;margin-top:3px}
...
<script>
  (function(){
    ...
    var categorySlug = '{{ $category->slug ?? ("category_".$category->id) }}';
    ...
    function initViewSwitcher(){
      ...
      currentView = localStorage.getItem('categoryViewMode') || 'list';
    ...
    function loadMorePosts(){
      ...
      currentPage++;
      var url = '{{ route("site.category.loadMore", ["slug" => ":slug"]) }}'.replace(':slug', categorySlug) + '?page=' + currentPage;
