      ...
      <div class="card-bd">
        ...
        @else
          <div style="padding:40px;text-align:center;color:#999;">
            <i class="bi bi-heart" style="font-size:48px;margin-bottom:12px;display:block;opacity:0.5"></i>
...
<script>
  (function(){
    var currentPage = 1;
    var isLoading = false;
    var hasMore = {{ $likes->hasMorePages() ? 'true' : 'false' }};
    ...
    function renderPostHTML(post){
      ...
      html += '<div class="post-meta-item post-like-item" data-post-id="' + (post.id || '') + '" style="cursor:pointer;user-select:none;"><i class="bi bi-hand-thumbs-up-fill"></i> <span class="likes-count">' + (post.likes_count || 0) + '</span></div>';
      html += '<div class="post-meta-item post-favorite-item" data-post-id="' + (post.id || '') + '" style="cursor:pointer;user-select:none;"><i class="bi bi-star"></i> <span class="favorites-count">' + (post.favorites_count || 0) + '</span></div>';
      html += '</div>';
    ...
    function loadMorePosts(){
      ...
      currentPage++;
      var url = '{{ route("site.member.likes.loadMore") }}?page=' + currentPage;
