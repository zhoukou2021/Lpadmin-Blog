...
(function(){
    ...
    if (typeof window.BlogCategoryConfig === 'undefined') {
        console.error('BlogCategoryConfig is not defined');
        return;
    }
    
    var config = window.BlogCategoryConfig;
    var currentPage = 1;
    var isLoading = false;
    var hasMore = config.hasMore || false;
    var categorySlug = config.categorySlug || '';
    ...
    function loadMorePosts(){
      ...
      currentPage++;
      var url = config.loadMoreUrl.replace(':slug', categorySlug) + '?page=' + currentPage;
